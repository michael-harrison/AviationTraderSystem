<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SpecgroupEditor.aspx.vb" Inherits="SpecgroupEditor" %>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td class="contenttext right_text">
                                                    Number of ads in this Specgroup:
                                                </td>
                                                <td align='left'>
                                            ...
                                            <tr>
                                                <td class="contenttext right_text">
                                                    Move all Spec definitions to another Spec group
                                                </td>
                                                <td align='left'>
                                                    <asp:DropDownList ID="SpecgroupDD" CssClass="contentfield" DataTextField="Name" DataValueField="hexid" EnableViewState="true" runat="server" />

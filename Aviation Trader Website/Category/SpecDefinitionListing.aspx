<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SpecDefinitionListing.aspx.vb" Inherits="Category_SpecDefinitionListing" %>
            ...
            <div id="contentpanel1">
                <div style="border: solid 1px #c0c0c0; padding-bottom: 10px;">
                    <table border="0" width="100%" style="border-collapse: collapse">
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="SpecDefinitionList" CellPadding="5" BorderStyle="None" HeaderStyle-BackColor="#eaeaea" EnableViewState="false" CssClass="contenttextleft" Width="100%" runat="server" AutoGenerateColumns="False">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="center" HeaderText="Display Type" ItemStyle-CssClass="contentfield center" DataField="DisplayType" />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ClassificationListing.aspx.vb" Inherits="Category_ClassificationListing" %>
            ...
            <div id="contentpanel1">
                <div style="border: solid 1px #c0c0c0; padding-bottom: 10px;">
                    <table border="0" width="100%" style="border-collapse: collapse">
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="ClassificationList" CellPadding="5" ShowFooter="true" BorderStyle="None" HeaderStyle-BackColor="#eaeaea" FooterStyle-BackColor="#eaeaea" EnableViewState="false" CssClass="contentfield" Width="100%" runat="server" AutoGenerateColumns="False">
                                    <Columns>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CategoryListing.aspx.vb" Inherits="Category_CategoryListing" %>
            ...
            <div id="contentpanel1">
                <div style="border: solid 1px #c0c0c0; padding-bottom: 10px;">
                    <table border="0" width="100%" style="border-collapse: collapse">          <tr>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="CategoryList" CellPadding="5" ShowFooter="true" BorderStyle="None" HeaderStyle-BackColor="#eaeaea" FooterStyle-BackColor="#eaeaea" EnableViewState="false" CssClass="contentfield" Width="100%" runat="server" AutoGenerateColumns="False">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Classifications" HeaderStyle-Width="90px" HeaderStyle-HorizontalAlign="Right" ItemStyle-CssClass="contentfield right" FooterStyle-HorizontalAlign="Right">
                                            <ItemTemplate>
                                                <%#Container.DataItem.ClassificationCount%>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <%#ClassificationCountTotal%>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:BoundField HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="center" HeaderText="Include in Bar" ItemStyle-CssClass="contentfield center" DataField="IncludeInBar" />

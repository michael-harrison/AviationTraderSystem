<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BrowseList.aspx.vb" Inherits="BrowseList" %>
    ...
    <div id="container">
        ...
        <div id="wrapper">
            ...
            <div id="rightpanel" style="padding: 0px;">
                <uc17:AdRotator ID="AdRotator" category="Right" Height="1800" runat="server" />
            </div>

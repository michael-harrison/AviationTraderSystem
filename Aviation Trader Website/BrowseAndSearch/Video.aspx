<%@ Page Language="VB" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Video.aspx.vb" Inherits="Video" %>
                                ...
                                <td>
                                    <div id="adconstructor" style="border: solid 1px #c0c0c0; padding-top: 5px; min-height: 400px; height: auto!important; height: 400px;">
                                        ...
                                        <div style="margin: 10px">
                                            <iframe id="youtubeiframe" title="YouTube video player" class="youtube-player" type="text/html" width="560" height="345" frameborder="0" runat="server" />
                                        </div>
                                    </div>
                                </td>
                            </tr>

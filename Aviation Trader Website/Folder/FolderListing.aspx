<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FolderListing.aspx.vb" Inherits="FolderListing" %>
            ...
            <div id="contentpanel1">
                <div style="border: solid 1px #c0c0c0; padding-bottom: 10px;">
                    <table border="0" width="100%" style="border-collapse: collapse">
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="FolderList" CellPadding="5" ShowFooter="true" BorderStyle="None" HeaderStyle-BackColor="#eaeaea" FooterStyle-BackColor="#eaeaea" EnableViewState="false" CssClass="contentfield" Width="100%" runat="server" AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Name" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <a style="color: #5A86B3; text-decoration: none" href="<%# Container.DataItem.NavTarget %>">
                                                    <%#Container.DataItem.SpooledName%></a>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                TOTAL
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="center" HeaderText="Prodn Folder" ItemStyle-CssClass="contentfield center" DataField="IsProdnFolder" />

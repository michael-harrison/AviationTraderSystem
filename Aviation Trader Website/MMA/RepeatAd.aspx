<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RepeatAd.aspx.vb" Inherits="RepeatAd" %>
                            ...
                            <table border="0" width="100%" style="border-collapse: collapse">
                                ...
                                <tr>
                                    <td colspan="2" style="padding: 10px" class="storybody">
                                        The selected ad has been repeated and will appear in the next edition. The ad has been moved to "Submitted Ads. The ad number of the new ad is
                                        <asp:Label ID="adnumber" runat="server" />." 
                                        <br />
                                        <br />
                                    </td>
                                </tr>

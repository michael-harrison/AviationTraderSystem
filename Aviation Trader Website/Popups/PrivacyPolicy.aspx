<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PrivacyPolicy.aspx.vb" Inherits="PrivacyPolicy" %>
...
<body style="background:white;text-align:left;margin:30px">
    ...
    <div>
        <cc1:InsertFileText ID="InsertFileText" Filename="statictext/privacypolicy.txt" runat="server" />
    </div>
    </form>
</body>
</html>

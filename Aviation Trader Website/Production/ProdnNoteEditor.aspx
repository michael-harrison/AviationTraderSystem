<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProdnNoteEditor.aspx.vb" Inherits="Production_ProdnNoteEditor" %>
                                ...
                                <tr>
                                    <td style="padding-left: 10px">
                                        <table width="100%" border="0">
                                            ...
                                            <td><td style="height:10px"></td></td>
                                            <tr>
                                                <td align="left" style="width: 500px">
                                                    <asp:TextBox ID="ProdnResponse" TextMode="MultiLine" class="textinput" Height="180" Width="450" runat="server" />
                                                </td>
                                                <td class="contenttext">

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AboutPub.aspx.vb" Inherits="AboutPub" %>
            ...
            <div id="contentpanel1">
                <div style="border: solid 1px #c0c0c0; padding-bottom: 10px;">
                    <table border="0" width="100%">
                        ...
                        <cc1:InsertFileText ID="InsertFileText" Filename="statictext/aboutpub.txt" runat="server" />
                    </table>
                </div>
            </div>
        </div>

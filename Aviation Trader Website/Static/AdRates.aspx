<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AdRates.aspx.vb" Inherits="AdRates" %>
            ...
            <div id="contentpanel1">
                <div style="border: solid 1px #c0c0c0; padding-bottom: 10px;">
                    <table border="0" width="100%">
                        ...
                        <cc1:InsertFileText ID="InsertFileText" Filename="statictext/adRates.txt" runat="server" />
                    </table>
                </div>
            </div>
        </div>

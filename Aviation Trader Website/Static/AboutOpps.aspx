<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AboutOpps.aspx.vb" Inherits="AboutOpps" %>
            ...
            <div id="contentpanel1">
                <div style="border: solid 1px #c0c0c0; padding-bottom: 10px;">
                    <table border="0" width="100%">
                        ...
                        <tr>
                            <td>
                                <span class="storyhead">Promotional Opportunities</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="storypicpanel">
                                    <asp:Image ID="FrontPagePic" CssClass="storypic" runat="server" /><br />
                                </div>
                                <cc1:InsertFileText ID="InsertFileText" Filename="statictext/aboutOpps.txt" runat="server" />
                            </td>
                        </tr>
                    </table>
                </div>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="subsHome.aspx.vb" Inherits="SubsHome" %>
            ...
            <div id="contentpanel1">
                <div style="border: solid 1px #c0c0c0; padding-bottom: 10px;">
                    <table border="0" width="100%">
                        ...
                        <tr>
                            <td>
                                <span class="storyhead">Aviation Trader Subscriptions</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="storypicpanel">
                                    <asp:Image ID="CoverPic" CssClass="storypic" runat="server" /><br />
                                </div>
                                <cc1:InsertFileText ID="InsertFileText" Filename="statictext/SubsHome.txt" runat="server" />

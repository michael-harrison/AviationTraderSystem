...
Partial Class AboutOpps
    ...
    Private Sub displaytabBar()
        ...
        topnode = New MenuNode("D", "Our Publication", Loader.Target, False)
        tabbar.Nodes.Add(topnode)

        Loader.NextASPX = ATLib.Loader.ASPX.AboutOpps
        topnode = New MenuNode("E", "Opportunities", Loader.Target, True)
        tabbar.Nodes.Add(topnode)
    ...
    Private Sub displayContent()
        ...
        frontpagePic.ImageUrl = sys.FrontImageURL

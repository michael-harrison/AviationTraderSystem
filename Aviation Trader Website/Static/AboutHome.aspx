<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AboutHome.aspx.vb" Inherits="AboutHome" %>
            ...
            <div id="contentpanel1">
                <div style="border: solid 1px #c0c0c0; padding-bottom: 10px;">
                    <table border="0" width="100%">
                        ...
                        <tr>
                            <td>
                                <span class="storyhead">Welcome</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <cc1:InsertFileText ID="InsertFileText" Filename="statictext/abouthome.txt" runat="server" />
                            </td>
                        </tr>
                    </table>
                </div>
